          ...
          <div className="text-center space-y-8 flex flex-col gap-6 items-center">
            ...
            <div className="space-y-4 text-gray-600 max-w-2xl mx-auto">
              <p className="leading-relaxed text-sm sm:text-base">
                L&apos;Orchestre Universitaire de Metz a été fondé en décembre
                2023 dans le but de créer des liens entre les étudiants de
                différents départements d&apos;études, autour d&apos;une passion
                commune, la musique.
              </p>
